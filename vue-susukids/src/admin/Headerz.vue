    ...
    <div>
        ...
        <q-drawer
            ...
            <q-list style="padding: 20px;">
                ...
                <q-item clickable tag="a" href="/#/databarang">
                    <q-item-section avatar>
                ...
                <q-item clickable tag="a" href="/#/transaksi">
                    <q-item-section avatar>
                        <i class="far fa-credit-card" style="font-size:20px;"></i>
                    </q-item-section>
                    <q-item-section>
                        <q-item-label>Data Transaksi</q-item-label>
                    </q-item-section>
                </q-item>
                ...
                <q-item clickable tag="a" href="/#/">
                    ...
                    <q-item-section>
                        <q-item-label>Tarik Data Transaksi</q-item-label>
                    </q-item-section>
                </q-item>
